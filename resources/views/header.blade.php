@section('header')
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-transparent">
        <div class="container">
            <a class="navbar-brand" aria-label="მთავარი გვერდი" href="/">
                <div class="">
                    <svg width="171" height="45" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link  dropdown-toggle" href="/movies"><span
                                class="sc-14ko3df-2 bIHpEd"><svg class="svg-icon svg-icon--movies" width="30"
                                                                 height="24"
                                        ...
                                        fill="#fff"></path></svg></span><span class="sc-14ko3df-1 ebrqGL">ფილმები</span></a>

                        <div class="dropdown-menu">
                            <div class="menu">
                            <a href="/movies/georgian">ქართულად გახმოვანებული</a><span
                                class="seperator">|</span><a href="/movies?genre=265">ანიმაცია</a><span
                                class="seperator">|</span><a href="/movies?genre=252">დოკუმენტური</a><span
                                class="seperator">|</span><a href="/trailers">თრეილერები</a><span
                                class="seperator">|</span><a
                                href="/collections">კოლექციები</a></div>
                        </div>
                    </li>
                    @if(auth()->check())
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button class="btn btn-primary" type="submit">გასვლა</button>
                        </form>
                    </li>
                        @if(\App\User::isAdmin())
                            <li class="nav-item dropdown">
                            <a class="nav-link btn btn-primary  dropdown-toggle" href="{{route('listmovies')}}">კინოები</a>
                            <div class="dropdown-menu">
                                <div class="menu">
                                    <a class="btn btn-primary" href="{{route('createmovie')}}">კინოს დამატება</a>
                                </div>
                            </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link btn btn-primary  dropdown-toggle" href="{{route('listgenres')}}">ჟანრები</a>
                                <div class="dropdown-menu">
                                    <div class="menu">
                                        <a class="btn btn-primary" href="{{route('creategenre')}}">ჟანრის დამატება</a>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link btn btn-primary  dropdown-toggle" href="{{route('listcountries')}}">ქვეყნები</a>
                                <div class="dropdown-menu">
                                    <div class="menu">
                                        <a class="btn btn-primary" href="{{route('createcountry')}}">ქვეყნის დამატება</a>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link btn btn-primary  dropdown-toggle" href="{{route('listtags')}}">თეგები</a>
                                <div class="dropdown-menu">
                                    <div class="menu">
                                        <a class="btn btn-primary" href="{{route('createtag')}}">თეგის დამატება</a>
                                    </div>
                                </div>
                            </li>
{{--                            <li><a class="btn btn-primary" href="{{route('createmovie')}}">კინოს დამატება</a></li>--}}
{{--                            <li><a class="btn btn-primary" href="{{route('listmovies')}}">კინოები</a></li>--}}
                        @endif
                    @else
                        <li><a  class="btn btn-primary" href="{{route('login')}}">შესვლა</a></li>
                        <li><a  class="btn btn-primary" href="{{route('register')}}">რეგისტრაცია</a></li>
                    @endif
